...
public class MyActivity extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 1:
                    BreakfastFragment bTab = new BreakfastFragment();
                    return breakfastFragment;
                case 2:
                    LunchFragment lTab = new LunchFragment();
                    return lunchFragment;
                case 3:
                    SnackFragment sTab = new SnackFragment();
                    return snackFragment;
                case 4:
                    DinnerFragment dTab = new DinnerFragment();
